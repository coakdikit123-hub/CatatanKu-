...
// Import dengan fallback jika modul tidak tersedia
let Telegraf, PDFDocument, axios, ocrStrukWithPuter;
...
try {
  ...
  console.warn('⚠️ OCR module tidak tersedia:', e.message);
...
console.log('🔍 OCR available?', !!ocrStrukWithPuter);
...
if (BOT_TOKEN && Telegraf) {
  try {
    ...
    // ============================================================
    // HANDLER: FOTO — OCR + EDIT (jika OCR tersedia)
    // ============================================================
    if (ocrStrukWithPuter && axios) {
...
app.get('/api/health', (req, res) => {
  res.json({ 
    ...
    ocr_available: !!ocrStrukWithPuter,
